...
void ILI9163_initnew(int rotation)
{
    HAL_GPIO_WritePin(DISP_CS_Port, DISP_CS_Pin, 0);
    ...
    ILI9163_writeCommand(0x11); // Exit Sleep
    HAL_Delay(50);

    ILI9163_writeCommand(0x26); // Set Default Gamma
    ILI9163_writeData(0x04);
    ILI9163_writeCommand(0xB1);
    ILI9163_writeData(0x08); // 10
    ILI9163_writeData(0x10); // 08
    ILI9163_writeCommand(0xC0); // Set VRH1[4:0] & VC[2:0] for VCI1 & GVDD
    ILI9163_writeData(0x0C);
    ILI9163_writeData(0x05);
    ILI9163_writeCommand(0xC1); // Set BT[2:0] for AVDD & VCL & VGH & VGL
    ILI9163_writeData(0x02);
    ILI9163_writeCommand(0xC5); // Set VMH[6:0] & VML[6:0] for VOMH & VCOML
    ILI9163_writeData(0x4E);
    ILI9163_writeData(0x30);
    ILI9163_writeCommand(0xC7);
    ILI9163_writeData(0xc0); // offset=0//C0
    ILI9163_writeCommand(0x3A); // Set Color Format

    ILI9163_writeData(0x55); // 55

    ILI9163_writeCommand(0x2A); // Set Column Address
    ILI9163_writeData(0x00);
    ILI9163_writeData(0x00);
    ILI9163_writeData(0x00);
    ILI9163_writeData(0x7F);
    ILI9163_writeCommand(0x2B); // Set Page Address
    ILI9163_writeData(0x00);
    ILI9163_writeData(0x00);
    ILI9163_writeData(0x00);
    ILI9163_writeData(0x9F);
    //   ILI9163_writeCommand(0xB4);  //frame inversion
    //	ILI9163_writeData(0x07);
    ILI9163_writeCommand(0x36); // Set Scanning Direction
    ILI9163_writeData(0xC0);
    //   ILI9163_writeCommand(0xEC);  //Set pumping clock frequency
    // ILI9163_writeData(0x0B);
    ILI9163_writeCommand(0xF2); // Enable Gamma bit
    ILI9163_writeData(0x01);

    ILI9163_writeCommand(0xE0);
    ILI9163_writeData(0x3F); // p1          // xx VP63[5:0]             //       //
    ILI9163_writeData(0x31); // p2          // xx VP62[5:0]             //       //
    ILI9163_writeData(0x2D); // p3         // xx VP61[5:0]             //       //
    ILI9163_writeData(0x2F); // p4          // xx VP59[5:0]             //       //
    ILI9163_writeData(0x28); // p5          // xx VP57[5:0]             //       //
    ILI9163_writeData(0x0D); // p6         // xxx VP50[4:0]  //       //
    ILI9163_writeData(0x59); // p7          // x VP43[6:0]              //       //
    ILI9163_writeData(0xA8); // p8          // VP36[3:0] VP27[3:0]        //       //
    ILI9163_writeData(0x44); // p9          // x VP20[6:0]              //       //
    ILI9163_writeData(0x18); // p10       // xxx VP13[4:0]  //       //
    ILI9163_writeData(0x1F); // p11       // xx VP6[5:0]               //       //
    ILI9163_writeData(0x10); // p12       // xx VP4[5:0]               //       //
    ILI9163_writeData(0x07); // p13       // xx VP2[5:0]               //       //
    ILI9163_writeData(0x02); // p14       // xx VP1[5:0]               //       //
    ILI9163_writeData(0x00); // p15       // xx VP0[5:0]               //       //
    ILI9163_writeCommand(0xE1);
    ILI9163_writeData(0x00); // p1          // xx VN0[5:0]               //       //
    ILI9163_writeData(0x0E); // p2         // xx VN1[5:0]               //       //
    ILI9163_writeData(0x12); // p3          // xx VN2[5:0]               //       //
    ILI9163_writeData(0x10); // p4          // xx VN4[5:0]              //       //
    ILI9163_writeData(0x17); // p5          // xx VN6[5:0]               //       //
    ILI9163_writeData(0x12); // p6          // xxx VN13[4:0] //       //
    ILI9163_writeData(0x26); // p7          // x VN20[6:0]              //       //
    ILI9163_writeData(0x57); // p8          // VN36[3:0] VN27[3:0]       //       //
    ILI9163_writeData(0x3B); // p9         // x VN43[6:0]              //       //
    ILI9163_writeData(0x07); // p10       // xxx VN50[4:0] //       //
    ILI9163_writeData(0x20); // p11       // xx VN57[5:0]            //       //
    ILI9163_writeData(0x2F); // p12       // xx VN59[5:0]            //       //
    ILI9163_writeData(0x38); // p13       // xx VN61[5:0]            //       //
    ILI9163_writeData(0x3D); // p14       // xx VN62[5:0]            //       //
    ILI9163_writeData(0x3f); // p15         // xx VN63[5:0]            //       /
...
void ILI9163_init(int rotation)
{
    ...
    ILI9163_writeData(0x02); // BT = 2: AVDD = 2xVCI1, VCL = -1xVCI1, VGH = 5xVCI1, VGL =
    -2xVCI1
